    ...
    <>
      ...
      >
        <div
          className="
            mx-auto
            flex h-[85px] max-w-[1280px]
            items-center justify-between
            gap-5 px-6
            max-md:h-[78px] max-md:px-[18px]
          "
        >
          {/* LOGO */}
          <Link to="/" className="flex items-center no-underline">
            <img
              ...
              alt="CFOUR Logo"
              className="
                block w-[150px] cursor-pointer
                transition-transform duration-300
                hover:scale-105
                max-md:w-[120px] max-[480px]:w-[100px]
              "
            />
          </Link>
            ...
            {navLinks.map((l) => (
              <Link
                ...
                className="
                  ...
                  text-[15px] font-medium text-[#111]
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <button
              ...
              className="
                ...
                transition-all duration-300
                hover:-translate-y-[2px] hover:bg-gray-100
              "
            >
              <ShoppingCart
                size={20}
            ...
            <button
              ...
              className="
                ...
                transition-all duration-300
                hover:-translate-y-[2px] hover:bg-black
              "
            >
              <User size={16} />
        ...
        <div className="fixed inset-0 z-[1200]" role="dialog" aria-modal="true">
          ...
          <aside
            className="
              ...
              flex w-[85%] max-w-[360px] flex-col
              bg-white p-[22px]
          ...
          >
            ...
            {/* LINKS */}
            <nav className="mt-[30px] flex flex-col gap-[6px]">
              {navLinks.map((l, i) => (
                <Link
                  key={l.label}
                  to={l.href}
                  ...
                  onClick={() => setMobileOpen(false)}
                  className="
                    rounded-[10px] px-[14px] py-[14px]
                    text-[16px] font-medium text-[#111]
                    transition-all duration-300
